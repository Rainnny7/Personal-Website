...
export default function Card(props) {
	return (
		<ScaleUpHoverAnimation>
			<div className="relative transition ease-in-out delay-100 rounded-xl opacity-90 hover:opacity-100 bg-gradient-to-br from-blue-700 via-purple-600/10 to-red-700 p-0.5 before:absolute before:inset-0 before:h-full before:w-full before:rounded-xl before:bg-gradient-to-br before:from-blue-500 before:via-purple-500/30 before:to-red-500 before:blur-3xl">
