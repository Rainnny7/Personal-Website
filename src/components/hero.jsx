...
export default function Hero() {
	return (
		<div className="flex flex-col gap-3 px-6 text-center">
			{/* Name */}
			<a className="text-5xl font-bold text-slate-300">Braydon Rainnny</a>

			{/* Typewriter */}
			<a className="flex flex-wrap justify-center font-serif text-3xl text-center text-slate-400">
